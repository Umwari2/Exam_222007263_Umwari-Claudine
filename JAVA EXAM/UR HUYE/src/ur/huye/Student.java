...
public class Student extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            PreparedStatement ps=con.prepareStatement("insert into school(name,age,gender)values(?,?,?)");
            ps.setString(1,name);
            ps.setString(2,age);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost/demo","root","");
            PreparedStatement ps=con.prepareStatement("update school set name=?,age=?,gender=? where id=?");
            ps.setString(1,name);
            ps.setString(2,age);
            if(jRadioButton1.isSelected())
            {
